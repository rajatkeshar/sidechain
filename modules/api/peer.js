 ...
 * @param {Peer~getPeersCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Peer~getPeerCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Peer~versionCallback} cb - Callback handles response from BEL.
 */
