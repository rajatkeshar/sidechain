 ...
 * @param {Transport~message} cb - Callback handles response from BEL.
 */
 ...
 * @param query - Query.
 * @param {Transport~getRandomPeerCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param path - Path (part of url).
 * @param query - Query.
 * @param {Transport~getPeerCallback} cb - Callback handles response from BEL.
 */
