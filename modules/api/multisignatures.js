 ...
 * @param {Multisignatures~pendingCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Multisignatures~signCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Multisignatures~addCallback} cb - Callback handles response from BEL.
 */
