 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from BEL.
 */
