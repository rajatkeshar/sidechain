 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from BEL
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from BEL.
 */
