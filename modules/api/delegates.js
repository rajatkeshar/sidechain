 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from BEL.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from BEL.
 */
 ...
 * @param error - Error of api call execution.
 * @param response - Response of api call execution.
 * @param response.fees - Amount of BEL that delegate forged.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from BEL.
 */
