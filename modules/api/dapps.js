 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from BEL.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from BEL.
 */
 ...
 * @param cb - Callback handles response from BEL.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from BEL.
 */
